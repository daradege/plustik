...
how to create inline keyboard in plustik
...
.. code-block:: python
    ...
    from plustik.objects import Message, CallbackQuery
    from plustik.objects import InlineKeyboardMarkup
    from plustik.objects.enums import ButtonTypes
